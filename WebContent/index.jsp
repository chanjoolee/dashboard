...
<script type="text/javascript">
	...
	function gotoPhaseCauseList(){
	    window.open('./jiraIssuePhaseCauseList.do?sender=confluence','_blank',
	...
	function gotoCauseMatrixList(){
	    window.open('./jiraIssueCauseMatrixList.do?sender=confluence','_blank',
	...
	function gotoCauseStatusList(){
	    window.open('./jiraIssueCauseStatusList.do?sender=confluence','_blank',
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul id="navbar-first" class="nav navbar-nav">
				<li class="active"><a class="dropdown-item" href="#" onclick="dashboardShow('frame_content','./generic.do?sender=xxx&viewName=schema/genSrc0523_01.2020.02.06.02.03.01/document_home');">Home</a></li>
				<li><a class="dropdown-item" href="#" onclick="dashboardShow('frame_content','./generic.do?sender=xxx&viewName=schema/genSrc0523_01.2020.02.06.02.03.01/document_ck5');">Document</a></li>
				<!-- <li class=""><a href="#">Demo</a></li> -->
				<li><a class="dropdown-item" href="#" onclick="dashboardShow('frame_content','./generic.do?sender=xxx&viewName=schema/genSrc0523_01.2020.02.06.02.03.01/main');">Generate-Source</a></li>
				<!-- locale -->
				<li class="btn-group">
...
<div style="margin-top: 52px;"><iframe id="frame_content" src="./generic.do?sender=xxx&viewName=schema/genSrc0523_01.2020.02.06.02.03.01/document_home" name="frame_content" style="width: 100%; height: 1000px;"></iframe></div>
