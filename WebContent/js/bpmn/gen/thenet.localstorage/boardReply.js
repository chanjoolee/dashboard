		jpaFiles.push({
										...
										"elements": [
											{
												...
												"elements": [
													{
														"type": "SearchHeader",
														"id": "boardBoardIdSearchHeader",
														"name": "boardBoardIdSearchHeader",
														"label": "",
														"text": "Boardid",
													...
													{
														"type": "multiCombo",
														"id": "boardBoardIdSearchMultiCombo",
														"name": "boardBoardIdSearchMultiCombo",
														"label": "",
														"text": "Board_id",
														"jpa_column": {
															"parent_column": "board_id",
															"child_column": "board_id"
														},
														"events": {
															"change": function(e){
															                    // fn_search();
														...
														"sqlId": "boardReply.board.multicombo",
														"entityId": "board",
														"multiselectOpt": {
															"multiple": true
														},
									                                                ...
									                                                fn_submit: function(){
									                                                    ...
									                                                    $.ajax({
									                                                        ...
									                                                        data: {
									                                                            ...
									                                                            sqlid: "boardReply.boardReply.edit"
									                                                        }, 
									                                                        async: false,			                    		
								...
								"items": [
									{
										...
										"required": true,
										"referenceId": "reference::board::board_reply",
										"topRefrenceId": "reference::board::board_reply",
										"editoptions": {
											"dataEvents": []
										},
			...
			"gridProperties": [
				...
				{
					"type": {
						"_href": "http://www.eclipse.org/emf/2002/Ecore#//EIntegerObject",
						"__prefix": null
					},
					"_name": "board_seq",
					"__prefix": null,
			...
			"dataSources": [
				{
					...
					"topRefrenceId": "reference::board::board_reply",
					"parentEntity": "board",
					"parentColumnName": "board_id",
					"childColumnName": "board_id",
					"childColumnNames": [
						"board_id"
					],
					"parentNameColumn": "board_id",
					"parentColumnNames": [
						"board_id"
					],
					"topEntity": "board",
					"topColumnName": "board_id",
					"topColumnNames": [
						"board_id"
					],
					"topNameColumn": "board_id",
					"sqlId": "boardReply.datasrc.board.boardId",
					...
					"value": {},
					"sqlIdDynamic": "boardReply.datasrc.dynamic.board.boardId",
			...
			"dictionaries": [
				{
					"entityName": "board_reply",
					"sqlId": "boardReply.dictionary.boardReply",
