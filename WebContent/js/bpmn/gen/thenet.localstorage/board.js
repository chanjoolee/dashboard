								...
								"gridOpt": {
									...
									"url": function(){ 
									                    return	"./genericlListPageJson.html?" + 
									                        $("#form").serialize() + 
									                        "&sqlid=board.board.page.list" +  
									                        "&paging_sqlid=board.board.page.total" 
									                },
									...
									"subGridRowExpanded": function(parentRowID, parentRowKey){
									                        ...
									                        $.ajax({
									                            type: "POST",
									                            url: "./genericlListJson.html?sqlid=board.board.one" ,
									                            data: searchRow ,
									                            //data: $("#form").serialize(), 
									                            async: false,
			...
			"childReferences": [
				{
					...
					"parentEntityName": "board",
					"childEntityName": "board_reply",
					"childEntityId": "board_reply",
					"parent_columns": [
						"board_id"
					],
					"child_columns": [
