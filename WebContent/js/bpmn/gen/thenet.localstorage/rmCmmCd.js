		jpaFiles.push({
								...
								"gridOpt": {
									...
									"url": function(){ 
									                    return	"./genericlListPageJson.html?" + 
									                        $("#form").serialize() + 
									                        "&sqlid=rmCmmCd.rmCmmCd.page.list" +  
									                        "&paging_sqlid=rmCmmCd.rmCmmCd.page.total" 
									                },
									...
									"subGridRowExpanded": function(parentRowID, parentRowKey){
									                        ...
									                        $.ajax({
									                            type: "POST",
									                            url: "./genericlListJson.html?sqlid=rmCmmCd.rmCmmCd.one" ,
									                            data: searchRow ,
									                            //data: $("#form").serialize(), 
									                            async: false,
			...
			"dictionaries": [
				{
					"entityName": "rm_cmm_cd",
					"sqlId": "rmCmmCd.dictionary.rmCmmCd",
