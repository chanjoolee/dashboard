...
JpaAllGeneratorBracket.prototype.fn_entities_add = function (entity) {
    var _this = this;
    var file_name = _.camelCase( entity._name );
    var v_entity_doc_obj = _this.documentToObject(entity._documentation);
    if ( v_entity_doc_obj.dbType == null )
...
JpaAllGeneratorBracket.prototype.fn_entities_copy = function (entity) {
    var _this = this;
    var file_name = _.camelCase( entity._name );
    var v_entity_doc_obj = _this.documentToObject(entity._documentation);
    if ( v_entity_doc_obj.dbType == null )
...
JpaAllGeneratorBracket.prototype.fn_entities_edit = function (entity) {
    var _this = this;
    var file_name = _.camelCase( entity._name );
    var v_entity_doc_obj = _this.documentToObject(entity._documentation);
    if ( v_entity_doc_obj.dbType == null )
...
JpaAllGeneratorBracket.prototype.fn_entities_view = function (entity) {
    var _this = this;
    var file_name = _.camelCase( entity._name );
    var v_entity_doc_obj = _this.documentToObject(entity._documentation);
    if ( v_entity_doc_obj.dbType != null )
...
JpaAllGeneratorBracket.prototype.fn_generate_main = function () {
    var _this = this; 
...
JpaAllGeneratorBracket.prototype.fn_generate_script_schema_add = function( _file){
    var _this = this;
