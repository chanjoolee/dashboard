			...
			<div class="content pie">
				<div class="boxtitle">
					<div class="boxtitleinner">
						<p style="text-align: center;"><span><span style="font-weight: bold;"><span style="font-size: 16px;">CodeSonar Warning Trend</span></span></span></p>	
					</div>
				</div>		
				<div class="boxtext" id="content11">
					<iframe frameborder="0" id="projectOneStackByPCntDate" src="projectOneStackByPCntDate.html?pjt_code=${param.pjt_code}&sender=confluence"></iframe>
				</div>
			</div>			
		</li>		
	</ul>
	...
	<ul>
		<li id="container21" class="result8001" >
			<div class="content pie">
				<div class="boxtitle">
					<div class="boxtitleinner">
						<p style="text-align: center;"><span><span style="font-weight: bold;"><span style="font-size: 16px;">Current Warning : by Priority</span></span></span></p>	
					</div>
				</div>		
				<div class="boxtext" id="content21">
					<iframe frameborder="0" id="codesonarDetailPriority" src="codesonarDetailPriority.html?pjt_code=${param.pjt_code}&sender=confluence"></iframe>
				</div>
			</div>	
		...
		<li id="container22" class="result8001" >
			<div class="content pie">
				<div class="boxtitle">
					<div class="boxtitleinner">
						<p style="text-align: center;"><span><span style="font-weight: bold;"><span style="font-size: 16px;">Current Warning : by Warning Class</span></span></span></p>	
					</div>
				</div>		
				<div class="boxtext" id="content21">
					<iframe frameborder="0" id="codesonarDetailClass" src="codesonarDetailClass.html?pjt_code=${param.pjt_code}&sender=confluence" ></iframe>
				</div>
			</div>	
	...
	<ul>
		<li id="container31" class="result8001" >
			<div class="content pie">
				<div class="boxtitle">
					<div class="boxtitleinner">
						<p style="text-align: center;"><span><span style="font-weight: bold;"><span style="font-size: 16px;">Current Warning : by File</span></span></span></p>	
					</div>
				</div>		
				<div class="boxtext" id="content31">
					<iframe frameborder="0" id="codesonarDetailFile" src="codesonarDetailFile.html?pjt_code=${param.pjt_code}&sender=confluence" ></iframe>
				</div>
			</div>	
			
		</li>
		
		<li id="container32" class="result8001" >
			<div class="content pie">
				<div class="boxtitle">
					<div class="boxtitleinner">
						<p style="text-align: center;"><span><span style="font-weight: bold;"><span style="font-size: 16px;">Current Warning : by Procedure</span></span></span></p>	
					</div>
				</div>		
				<div class="boxtext" id="content32">
					<iframe frameborder="0" id="codesonarDetailFunction" src="codesonarDetailFunction.html?pjt_code=${param.pjt_code}&sender=confluence" ></iframe>
				</div>
			</div>	
