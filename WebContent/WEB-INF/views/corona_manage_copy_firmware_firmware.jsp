			...
			elements:[
				{
					...
					type:"title",
					id: "title_script",
					label: "Firmware Script Template"
				},
				{
					label:'',
											...
											events:{
												change : function(){
													...
													$.ajax({
														type: "POST",
														url: "/dashboard/genericlListJson.html",
														data: {sqlid: "dashboard.corona.search.firmware",sample: $("#from_sample").val() }, 
														async: false,
														success:  function(response){
	...
	function fn_copy(){
		...
		$.ajax({
			...
			data: {
				...
				sqlid: "dashboard.corona.manage.insert.historyno.copy_firmware_firmware"
			}, 
			async: false,			                    		
			success:  function(data){
				response1 = data;
		...
		$.ajax({
			...
			data: {
				searchJson: JSON.stringify(paramObj),
				history_no : v_hystoryno ,
				sqlid: "dashboard.corona.manage.firmware_copy_firmware.update"
			}, 
			async: false,			                    		
			success:  function(data){
				response1 = data;
