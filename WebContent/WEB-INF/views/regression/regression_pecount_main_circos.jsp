   ...
   <!--  <link rel="stylesheet" href="js/jqGrid_JS_5.1.0/css/ui.jqgrid.css" type="text/css" /> --> 
	...
	function drawCircosScatter(){
		...
		var chart_param = {
			...
			seriesIndex:{sql:'create index idx_GROUP_NAME on main(GROUP_NAME)', index : 'idx_GROUP_NAME'},
			//filters: [] ,
			convertDefiines: [] ,
			xCategoryCol : 'GROUP_SLOTNAME',
			xCategoryColOrderbyStr : 'GROUP_NAME,SLOTNAME',
        ...
        $.each(series.series,function(i,s){
        	...
        	var dataAvg1 = s.data.map(function(d,j){        		
        		return {
        			block_id: s.name,
        	...
        	dataAvg = dataAvg.concat(dataAvg1);
        });
		...
		.scatter('dataAvg', dataAvg.filter(function(d){ return true;}), {
	        	innerRadius: 0.8,
	        	outerRadius: 0.98,
	        	logScale: false,
	       		color: '#d3d3d3',
