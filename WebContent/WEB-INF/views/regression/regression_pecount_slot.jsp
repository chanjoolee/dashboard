      	            ...
      	            data: function(){
        			   ...
        			   var paramObj = {
   	            		...
   	            		$.ajax({
							...
							data: {sqlid: "dashboard.regresson.pecountlist.by.slotName", searchJson: JSON.stringify(paramObj) }, 
   	                		async: false,
   	            ...
   	            ,
   	            {
			    	...
			    	data: function(){ 
			    		...
			    		$.ajax({
			    			type: "POST",
			    			url: "/dashboard/genericlListJson.do",
			    			data: {searchJson: JSON.stringify(paramObj), sqlid: 'dashboard.regresson.pecountlist.raw.new1' }, 
			    			async: false,
			    			success:  function(response){
