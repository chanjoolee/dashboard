			...
			elements:[ 
				{
			    	...
			    	form_id: 'form',
			    	items:[
						{label:'Size',name:'Size', viewName: 'regression/regression_host_main_data_circos1_size'},
						{label:'Latency Max',name:'dataMax', viewName: 'regression/regression_host_main_data_circos1_max'},
						{label:'Latency Min',name:'dataMin', viewName: 'regression/regression_host_main_data_circos1_min'},
						{label:'Count',name:'dataCnt', viewName: 'regression/regression_host_main_data_circos1_count'}
