...
<head>
   ...
   <!--  <link rel="stylesheet" href="js/jqGrid_JS_5.1.0/css/ui.jqgrid.css" type="text/css" /> --> 
	...
	<script src="/dashboard/js/Highcharts-5.0.7/code/modules/heatmap.src.js"></script>
					...
					type:'chart',
      	            ...
      	            data: function(){
        			   ...
        			   var paramObj = {
               			...
               			//alasql('create index idx_FWREV on main(CATEGORY,FIRMWARE_REVISION)');
   	            	...
   	            	options: function(){
   	            		var option = {
	            			    ...
	            			    tooltip: {
	            			        useHTML: true,
	            			        headerFormat: '<table>',
	            			        pointFormat: '<tr><th>FW Revision:</th><td>{point.FIRMWARE_REVISION}</td</tr>' +
