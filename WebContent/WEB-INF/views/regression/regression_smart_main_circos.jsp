...
<head>
   ...
   <!--  <link rel="stylesheet" href="js/jqGrid_JS_5.1.0/css/ui.jqgrid.css" type="text/css" /> --> 
	...
	function drawCircosScatter(){
		...
		.scatter('dataNormal', dataNormal.filter(function(d){ return true;}), {
	        	innerRadius: 0.6,
	        	outerRadius: 0.98,
	        	logScale: false,
	       		color: '#d3d3d3',
// 	        color: function (d) {
// 	            if (d.value > 1000) { return '#4caf50' }
...
// 	        },
				...
				tooltipContent : function(d) {
					return '<div style="text-align:left;">' + 
					 d.id +' : ' + d.name+  '<br/>'	+
					"Normalized: " + Highcharts.numberFormat(d.value,0) + '' + '<br/>'	+
					"Project Code: " + d.project_code + '' + '<br/>'	+
					"Project Name: " + d.project_name + '' + '<br/>'	+
					"Firmware: " + d.firmware + '' + '<br/>'	+
			...
			.scatter('dataValue', dataValue.filter(function(d){ return true;}), {
	        	innerRadius: 0.3,
	        	outerRadius: 0.68,
	        	logScale: false,
	       		color: '#4caf50',
...
// 	        },
				...
				tooltipContent : function(d) {
					return '<div style="text-align:left;">' + 
					 d.id +' : ' + d.name+  '<br/>'	+
					"Value: " + Highcharts.numberFormat(d.value,0) + '' + '<br/>'	+
					"Project Code: " + d.project_code + '' + '<br/>'	+
					"Project Name: " + d.project_name + '' + '<br/>'	+
					"Firmware: " + d.firmware + '' + '<br/>'	+
					"Test Name: " + d.testname + '' + '<br/>'	+
