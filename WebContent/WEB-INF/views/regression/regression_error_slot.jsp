      	            ...
      	            data: function(){
        			   ...
        			   var paramObj = {
   	            		...
   	            		$.ajax({
							...
							//data: {sqlid: "dashboard.regresson.errologlist.by.slotName", searchJson: JSON.stringify(paramObj) }, 
							data: {sqlid: "dashboard.regresson.errologlist.by.slotName1", searchJson: JSON.stringify(paramObj) }, 
   	                		async: false,
   	            		...
   	            		var chart_param = {
            				...
            				seriesKey: {cd:'ERROR_TYPE', name:'ERROR_TYPE'},
            				seriesIndex:{sql:'create index idx_ERROR_TYPE on main(ERROR_TYPE)', index : 'idx_ERROR_TYPE'},
            				//filters: [] ,
   	            	...
   	            	options: function(){
   	            		var option = {
   	            			    ...
   	            			    ,tooltip: {
   	            			        ...
   	            			        headerFormat: '<table>',
   	            			        pointFormat: '' +
		         			            '<th>Error Type:</th><td>{point.ERROR_TYPE}</td></tr>' +
		         			            '<th>Slot Name:</th><td>{point.SLOTNAME}</td></tr>' +
   	            ...
   	            ,
   	            {
			    	...
			    	data: function(){ 
			    		...
			    		$.ajax({
			    			type: "POST",
			    			url: "/dashboard/genericlListJson.html",
			    			data: {searchJson: JSON.stringify(paramObj), sqlid: 'dashboard.regresson.errologlist.raw.new1' }, 
			    			async: false,
			    			success:  function(response){
			    	...
			    	items:[
						...
						{label:'Channel',name:'CHANNEL', id:'CHANNEL', sorttype: 'number', formatter:'number', align:'right',formatoptions:{decimalSeparator:",", thousandsSeparator: ",", decimalPlaces: 0},width: 70 ,
							searchoptions : {
	                            // show search options
	                            sopt: ["ge","le","eq"] // ge = greater or equal to, le = less or equal to, eq = equal to  							
							}		
						},
						{label:'Die',name:'DIE', id:'DIE',sorttype: 'number',  formatter:'number', align:'right',formatoptions:{decimalSeparator:",", thousandsSeparator: ",", decimalPlaces: 0},width: 70, 
							searchoptions : {
	                            // show search options
	                            sopt: ["ge","le","eq"] // ge = greater or equal to, le = less or equal to, eq = equal to  							
							}	
						},
						{label:'ISRTYPE',name:'ISRTYPE', id:'ISRTYPE',sorttype: 'number',  formatter:'number', align:'right',formatoptions:{decimalSeparator:",", thousandsSeparator: ",", decimalPlaces: 0},width: 70, 
							searchoptions : {
	                            // show search options
	                            sopt: ["ge","le","eq"] // ge = greater or equal to, le = less or equal to, eq = equal to  							
							}	
						},
						{label:'Page',name:'PAGE', id:'PAGE',sorttype: 'number',  formatter:'number', align:'right',formatoptions:{decimalSeparator:",", thousandsSeparator: ",", decimalPlaces: 0},width: 70, 
							searchoptions : {
	                            // show search options
	                            sopt: ["ge","le","eq"] // ge = greater or equal to, le = less or equal to, eq = equal to  							
							}	
						},
						{label:'Status',name:'STATUS', id:'STATUS',sorttype: 'number',  width: 70
						}
