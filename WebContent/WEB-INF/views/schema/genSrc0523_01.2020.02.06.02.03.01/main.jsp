<head><title>Generate Source By BPMN2</title>
		...
		var schemaTab ={
			...
			"elements": [
				...
				},
				{
					...
					"name": "gensrcCmmCdIframe",
					"label": "gensrcCmmCd",
					"connected_content": {
						"viewName": "schema/genSrc0523_01.2020.02.06.02.03.01/gensrcCmmCd",
						"form_id": "form"
					},
					"iframe_css": [
						{
				...
				},
				{
					...
					"label": "gensrcCmmUse",
					"connected_content": {
						"viewName": "schema/genSrc0523_01.2020.02.06.02.03.01/gensrcCmmUse",
						"form_id": "form"
					},
					"iframe_css": [
						{
				...
				
				{
					...
					"label": "gensrcTabCols",
					"connected_content": {
						"viewName": "schema/genSrc0523_01.2020.02.06.02.03.01/gensrcTabCols",
						"form_id": "form"
					},
					"iframe_css": [
						{
...
<form name="form" id="form" class="" action="./generic.do?viewName=gensrc/genSrcCustom/gensrcList" method="post" target="gensrcListIframeFrame">
