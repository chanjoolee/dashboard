...
<jsp:include page="/WEB-INF/views/include/include.toolbox.pmstable.jsp"></jsp:include>
	<script>
		...
		var dictionaries = [
			{
				"entityName": "gensrc_tab_cols",
				"sqlId": "gensrcTabCols.dictionary.gensrcTabCols",
		...
		var v_schema_content = {
			...
			"elements": [
				{
					"type": "grid",
					"id": "gensrcTabColsGrid",
					"name": "gensrcTabColsGrid",
					"label": "",
					"text": "Gensrc_tab_cols",
					"sqlId": "gensrcTabCols.gensrcTabCols",
					...
					"gridOpt": {
						"datatype": "json",
						"pager": "#gensrcTabColsGridPager",
						"sqlId": "gensrcTabCols.gensrcTabCols",
						"gridId": "gensrcTabColsGrid",
						"modelVarName": "genSrc052301Jpa",
						"url": function(){ 
						                    return	"${pageContext.request.contextPath}/genericlListPageJson.html?" + 
						                        $("#form").serialize() + 
						                        "&sqlid=gensrcTabCols.gensrcTabCols.page.list" +  
						                        "&paging_sqlid=gensrcTabCols.gensrcTabCols.page.total" 
						                },
						                            ...
						                            afterSubmit: function(response, postdata) { 
						                                ...
						                                $.ajax({
						                                    ...
						                                    data: {
						                                        ...
						                                        sqlid: "gensrcTabCols.gensrcTabCols.delete"
						                                    }  , 
						                                    async: false,
						                                    success:  function(data){
						                                        response1 = data;
						                                                ...
						                                                fn_submit: function(){
						                                                    ...
						                                                    $.ajax({
						                                                        ...
						                                                        data: {
						                                                            ...
						                                                            sqlid: "gensrcTabCols.gensrcTabCols.edit"
						                                                        }, 
						                                                        async: false,			                    		
						                                                        success:  function(data){
						                                                            response1 = data;
		...
		var commonFunc = {
			...
			"fn_view_detail": function(_type){
			                ...
			                $("#detailSqlId").val("gensrcTabCols.gensrcTabCols.one");
			                $("#detailSqlUpdateId").val("gensrcTabCols.gensrcTabCols.edit");
	...
	<script  id="script_main">
		$(function () {
			...
			setTimeout( function(){
				...
				if($("#filterPop").val() == "" ){
					...
					findAll("gensrcTabColsGrid",v_schema_content.elements)[0].label = "";
				}
		...
		function fn_search(){
			$("#loader").show();
			setTimeout( function(){
				var theGrid = $("#gensrcTabColsGrid").jqGrid();
