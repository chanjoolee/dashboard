...
<jsp:include page="/WEB-INF/views/include/include.toolbox.pmstable.jsp"></jsp:include>
	<script>
		...
		var dictionaries = [
			{
				"entityName": "gensrc_cmm_cd",
				"sqlId": "gensrcCmmCd.dictionary.gensrcCmmCd",
		...
		var childReferences = [
			{
				...
				"parentEntityName": "gensrc_cmm_cd",
				"childEntityName": "gensrc_cmm_use",
				"childEntityId": "gensrc_cmm_use",
				"parent_columns": [
					"code_category"
				],
				"child_columns": [
			...
			"elements": [
				{
					"type": "grid",
					"id": "gensrcCmmCdGrid",
					"name": "gensrcCmmCdGrid",
					"label": "",
					"text": "Gensrc_cmm_cd",
					"sqlId": "gensrcCmmCd.gensrcCmmCd",
					...
					"gridOpt": {
						"datatype": "json",
						"pager": "#gensrcCmmCdGridPager",
						"sqlId": "gensrcCmmCd.gensrcCmmCd",
						"gridId": "gensrcCmmCdGrid",
						"modelVarName": "genSrc052301Jpa",
						"url": function(){ 
						                    return	"${pageContext.request.contextPath}/genericlListPageJson.html?" + 
						                        $("#form").serialize() + 
						                        "&sqlid=gensrcCmmCd.gensrcCmmCd.page.list" +  
						                        "&paging_sqlid=gensrcCmmCd.gensrcCmmCd.page.total" 
						                },
						                            ...
						                            afterSubmit: function(response, postdata) { 
						                                ...
						                                $.ajax({
						                                    ...
						                                    data: {
						                                        ...
						                                        sqlid: "gensrcCmmCd.gensrcCmmCd.delete"
						                                    }  , 
						                                    async: false,
						                                    success:  function(data){
						                                        response1 = data;
						...
						"subGridRowExpanded": function(parentRowID, parentRowKey){
						                        ...
						                        $.ajax({
						                            type: "POST",
						                            url: "${pageContext.request.contextPath}/genericlListJson.html?sqlid=gensrcCmmCd.gensrcCmmCd.one" ,
						                            data: searchRow ,
						                            //data: $("#form").serialize(), 
						                            async: false,
						                            success:  function(response){
						                                                ...
						                                                fn_submit: function(){
						                                                    ...
						                                                    $.ajax({
						                                                        ...
						                                                        data: {
						                                                            ...
						                                                            sqlid: "gensrcCmmCd.gensrcCmmCd.edit"
						                                                        }, 
						                                                        async: false,			                    		
						                                                        success:  function(data){
						                                                            response1 = data;
		...
		var commonFunc = {
			...
			"fn_view_detail": function(_type){
			                ...
			                $("#detailSqlId").val("gensrcCmmCd.gensrcCmmCd.one");
			                $("#detailSqlUpdateId").val("gensrcCmmCd.gensrcCmmCd.edit");
	...
	<script  id="script_main">
		$(function () {
			...
			setTimeout( function(){
				...
				if($("#filterPop").val() == "" ){
					...
					findAll("gensrcCmmCdGrid",v_schema_content.elements)[0].label = "";
				}
		...
		function fn_search(){
			$("#loader").show();
			setTimeout( function(){
				var theGrid = $("#gensrcCmmCdGrid").jqGrid();
