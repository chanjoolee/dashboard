...
//                     }
	...
	function drawGrid(){
		...
		var gridModel = [
      		...
      		{ label: 'Phase', name:'Phase',width: 50,align:'center', sortable:false, 
      			formatter:  function(cellValue, options, rowObject) {
      				var pjtSchedule = dataFilter(scheduleSeries.series,[{col:'id',val:rowObject.PJT_CODE}]);
      				if(pjtSchedule.length == 0)
      					return '';
      				pjtSchedule = pjtSchedule[0];
      				var currentShedule = pjtSchedule.data[pjtSchedule.data.length - 1];
      				//return currentShedule.SUB_PHASE_NAME;
      				return currentShedule.CUR_PJT_PHASE_NM;
      			} 
      		},
      		{ label: 'Status', name:'Status', width: 50,align:'left', sortable:false, 
      			formatter:  function(cellValue, options, rowObject) {
      				var result = "";
      				var labelHtml = "";
      				var statusHtml = "";
      				...
      				if(currentShedule.PJT_STATE_NAME !='Proceeding'){
      					...
      					statusHtml = "<span title=\""+delayDt+" days delayed\" style=\"float: left;\" class=\"signal1\"></span>";
      					//labelHtml = "<span title=\""+delayDt+" days delayed\" > "+  delayDt + ' days delayed'+ "</span>";
      					...
      					//$("#currentStatusLabel").text(delayDt + ' days delayed');
      					statusHtml = "<span title=\""+delayDt+" days delayed\" style=\"float: left;\" class=\"signal2\"></span>";
      					//labelHtml = "<span title=\""+delayDt+" days delayed\"> "+  delayDt + ' days delayed'+ "</span>";
      				}else{
      					//$("#currentStatusSignal").attr("class","signal3");
      					//$("#currentStatusLabel").text('On Schedule');
      					statusHtml = "<span title=\"On Schedule\" style=\"float: left;\" class=\"signal3\"></span>";
      					//labelHtml = "<span title=\"On Schedule\"> On Schedule</span>";
      				}
      				
      				result = labelHtml + statusHtml;
      				return result;
      				
      				
      			},
      			cellattr:  function(rowId, val, rowObject, cm) {
      				var result = "";
      				//result +=" title=\""+val+"\"";
