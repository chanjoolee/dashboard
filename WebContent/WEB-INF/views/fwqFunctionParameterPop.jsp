...
<head>
	...
	<title>FWQ Function Parameter Pop</title>
...
// 	$.jgrid.defaults.styleUI = 'Bootstrap';
	...
	var schema = {
			...
			elements:[
				{
					label:'Function Parameter Details',
					type: 'Group',
					elements:[
					    {
					    	type:'grid',
					    	...
					    	items:[
								{label:'Measure Dt', name:'MEASURE_DT',width:90, sortable: false, editable: false, search:false},
								{label:'Project', name:'PROJECT',width:100, sortable: false, editable: false, search:false},
								{label:'Function', name:'FUNC_NAME',width:250, sortable: false , editable: false},
								{label:'Parameters', name:'PARAMETERS',width:80, sortable: true , editable: false,align:'center', search:false},
								{label:'p4Path', name:'P4_PATH',width:550, sortable: false , editable: false}
					    	],
					    	gridOpt:{
					    		datatype:'local',
					    		//userdata: "rows",
					    		...
					    		//url: '/dashboard/rest/fwq/functionParameter/list/${param.project}?measureDt=${param.measureDt}',
					    		//closeAfterEdit: true,
					    		width: '100%',
					    		//height: 600,
					    		height: '100%',
...
<script type="text/javascript">
	...
	function getDataByJson(){
		...
		$.ajax({
			url : "/dashboard/rest/fwq/functionParameter/list/${param.project}/${param.measureDt}",
