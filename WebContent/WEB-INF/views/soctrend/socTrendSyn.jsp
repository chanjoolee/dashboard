...
<head>
   ...
   <!--  <link rel="stylesheet" href="js/jqGrid_JS_5.1.0/css/ui.jqgrid.css" type="text/css" /> --> 
										...
										
										{
											...
											data: function(){
												var rtnList = [
													{code: 'LOGIC_GC_TOTAL'},
													{code: 'AREA_TOTAL'},
													{code: 'GATE_COUNT_TOTAL'},
													{code: 'LOGIC_AREA_TOTAL'},													
													{code: 'LOGIC_PERCENTAGE'},
													{code: 'MACRO_GC_TOTAL'},
													{code: 'MACRO_GC_TOTAL'},
													{code: 'MACRO_PERCENTAGE'}
												];
        			   ...
        			   var paramObj = {};
							...
							data: {sqlid: "dashboard.trendSyn.main", searchJson: JSON.stringify(paramObj) }, 
   	                		...
   	                		success:  function(response){
								...
								$.each(rtn.dataList ,function(){
									//this.y = this.LOGIC_GC_TOTAL;
									this.y = this[$("#target_logic").val()];
									
									// make x : date
									var dateSplit = this.START_TIME.split("/");
									var row1 = this;
									var y = row1.START_TIME.substr(0,4)
									var m = row1.START_TIME.substr(5,2)
									var d = row1.START_TIME.substr(7,2)
									var h = row1.START_TIME.substr(10,2)
									var mi = row1.START_TIME.substr(12,2)
									var utcdt = Date.UTC(y, m -1 , d, h,mi);
									this.x = utcdt;
            			...
            			/* var series = {series:[
            				{
            					name: "aaa",
            					data: rtn.dataList,
            					turboThreshold: rtn.dataList.length
            				}
            			]}; */
            			...
            			// make series
               			...
               			var chart_param = {
   	            				...
   	            				seriesKey: {cd:'MODULE_NAME', name:'MODULE_NAME'},
   	            				seriesIndex:{sql:'create index idx_MODULE_NAME on main(MODULE_NAME)', index : 'idx_MODULE_NAME'},
   	            				//filters: [] ,
   	            				convertDefiines: [] ,
   	            		...
   	            		// 1) Lable의 순서 변경(0/1 Depth 를 위로)
   	            		sortObjects(series.series,["order","name"]);
									...
									point:{	                	
										events:{
					                		click: function(event){
					                			...
					                			var linkUrl = "";
												// 1
												linkUrl +="<span style=\"cursor: pointer;\" onclick=\"fn_pop_diff('"+ event.point.options.START_TIME +"',this);\">";
												linkUrl +="Diff";
												linkUrl +="</span>";
												linkUrl +="<br/><br/>";
												// 2
	...
	function fn_pop_diff(start_time){
		...
		oFrm.action =  "http://solutionpms.skhynix.com/dashboard/das_sol/SoC_Methodology/Synthesis_diff/" + start_time + "_diff.json";
		oFrm.method = "post";
	...
	function fn_pop_log(start_time){
	...
	$(function () {
		loaderShow();
		setTimeout( function(){
			fn_makeHtml('contentSearch',schemaSearch);
...
<form name="form" id="form" class="">
	...
	<div id="contentSearch" style="margin-top: 10px;width: 100%;"></div> 
	...
	<div id="div2"></div>
	<div id="divTabs">
		<div style="width: 49% ;height: 700px; display: inline-block;"><iframe style="width: 100% ;height: 100%;" id="div_logic" name="div_logic" ></iframe></div>
		<div style="width: 49% ;height: 700px; display: inline-block;"><iframe style="width: 100% ;height: 100%;" id="div_macro" name="div_macro"></iframe></div>
	</div>
