				...
				elements:[ 
					...
					// target grid
					{
						...
						gridOpt:{
							datatype:'json',
							url: function(){
								return	"/dashboard/genericlListPageJson.html?" + $("#form").serialize() + "&sqlid=dashboard.corona.emmc.manage.script.scriptset.mapping.paging&paging_sqlid=dashboard.corona.emmc.manage.script.scriptset.mapping.paging.page";	
							},
