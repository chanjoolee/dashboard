					...
					elements: [
						{
			                            ...
			                            dataInit: function (element) {
										   $(element).attr("autocomplete","off").typeahead({ 
												...
												source: function(query, proxy) {
													$.ajax({
														url: '/dashboard/genericlListJson.do?sqlid=dashboard.corona.emmc.autocomplete.script&callback=?&field=CATEGORY',
														//dataType: "jsonp",
														data: {term: query},
														//dataType: "json",
														//success : proxy
									...
									,editoptions: {
			                            ...
			                            dataInit: function (element) {
										   $(element).attr("autocomplete","off").typeahead({ 
												...
												source: function(query, proxy) {
													$.ajax({
														url: '/dashboard/genericlListJson.do?sqlid=dashboard.corona.emmc.autocomplete.script&callback=?&field=TEST_ITEM',
														//dataType: "jsonp",
														data: {term: query},
														//dataType: "json",
														//success : proxy
					    	...
					    	gridOpt:{
								...
								url: function(){
									return	"/dashboard/genericlListPageJson.do?" + $("#form").serialize() + "&sqlid=dashboard.corona.emmc.manage.script.search.paging&paging_sqlid=dashboard.corona.emmc.manage.script.search.paging.page";
								},
					    			...
					    			v_grid.navGrid('#grid_scriptPager' ,
						    			...
						    			// options for the Script Master Add Dialog
						    			{
										    ...
										    { 
						                    	...
						                    	var response1 = {};
						                    	$.ajax({
						                    		url: "/dashboard/genericSaveJson.do?sqlid=dashboard.corona.emmc.script_master.insert",
						                    		type: "POST",
						                    		data: fd, 
						                    		async: false,
						                    		cache: false,
