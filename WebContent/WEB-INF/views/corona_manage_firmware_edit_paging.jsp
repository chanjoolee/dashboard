				...
				elements:[ 
					...
					// target grid
					{
						...
						items:[	
							...
							,{label:'Script', name:'CONVERT_SCRIPT', id:'CONVERT_SCRIPT', width:350, align:'left', sortable:false , editable: false}
							,{label:'TAT LVL', name:'SCRIPT_TAT_LVL', id:'SCRIPT_TAT_LVL', width:70, align:'left', sortable:false , editable: false }
							,{label:'Script Version', name:'SCRIPT_VERSION', id:'SCRIPT_VERSION', width:70, align:'left', sortable:false , editable: false }
						...
						gridOpt:{
							...
							url: function(){
								return	"/dashboard/genericlListPageJson.do?" + $("#form").serialize() + 
									"&sqlid=dashboard.corona.manage.script.firmware.mapping.paging" + 
									"&paging_sqlid=dashboard.corona.manage.script.firmware.mapping.paging.page" + 
