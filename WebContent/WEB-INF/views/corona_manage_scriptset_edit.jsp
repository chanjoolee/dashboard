					    			...
					    			v_grid.navGrid('#grid_scriptPager' ,
						    			...
						    			// options for the Script Master Add Dialog
						    			{
										    ...
										    { 
						                    	...
						                    	var response1 = {};
						                    	$.ajax({
						                    		url: "/dashboard/genericSaveJson.html?sqlid=dashboard.corona.scriptset.insert",
						                    		type: "POST",
						                    		data: fd, 
						                    		async: false,
						                    		cache: false,
...
//			});
	...
	function fn_pop_mgmt(v_scriptset){
		...
		//oFrm.menuAuthId.value = "MNU20150422131320740";
		//oFrm.action =  '/dashboard/generic.html?viewName=corona_manage_script';
		oFrm.action =  '/dashboard/generic.html?viewName=corona_manage_scriptset_script_edit';
		oFrm.method = "post";
