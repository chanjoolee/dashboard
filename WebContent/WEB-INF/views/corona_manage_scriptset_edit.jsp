									...
									formatoptions: {
				                        ...
				                        ,delOptions: {
				                        	onclickSubmit : function(options, rowid) {
					                        	...
					                        	row.sqlid = "dashboard.corona.scriptset.delete";					                        	;
				                        ...
				                        ,afterSave : function(rowid,res) {
				                        	var grid = $(this).jqGrid();
				                        	var row = grid.jqGrid('getRowData',rowid);
				                        	row.sqlid = "dashboard.corona.scriptset.update";
					    			...
					    			v_grid.navGrid('#grid_scriptPager' ,
						    			...
						    			// options for the Script Master Add Dialog
						    			{
										    ...
										    { 
						                    	...
						                    	var response1 = {};
						                    	$.ajax({
						                    		url: "/dashboard/genericSaveJson.do?sqlid=dashboard.corona.scriptset.insert",
						                    		type: "POST",
						                    		data: fd, 
						                    		async: false,
						                    		cache: false,
