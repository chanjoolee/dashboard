				...
				elements:[ 
					...
					// target grid
					{
						...
						gridOpt:{
							datatype:'json',
							url: function(){
								return	"/dashboard/genericlListPageJson.do?" + $("#form").serialize() + "&sqlid=dashboard.corona.manage.script.scriptset.mapping.paging&paging_sqlid=dashboard.corona.manage.script.scriptset.mapping.paging.page";	
							},
