...
<head>
    ...
    <title>UFS TestScript Set Edit</title>
		<%-- 1. jquery --%>
				...
				elements:[ 
					...
					// target grid
					{
						...
						items:[	
							...
							,{label:'TAT LVL', name:'SCRIPT_TAT_LVL', id:'SCRIPT_TAT_LVL', width:70, align:'left', sortable:false , editable: true }
							,{label:'Script Version', name:'SCRIPT_VERSION', id:'SCRIPT_VERSION', width:80, align:'left', sortable:false , editable: true }
						],							
						// target Grid option			
						gridOpt:{
							datatype:'json',
							url: function(){
								return	"/dashboard/genericlListPageJson.html?" + $("#form").serialize() + "&sqlid=dashboard.corona.manage.script.scriptset.mapping.paging&paging_sqlid=dashboard.corona.manage.script.scriptset.mapping.paging.page";	
							},
							...
							subGridRowExpanded: function(parentRowID, parentRowKey){
								...
								$.ajax({
									...
									data: {
										...
										, sqlid: 'dashboard.corona.manage.script.scriptset.mapping.one'}, 
									//data: $("#form").serialize(), 
									async: false,
									success:  function(response){
															...
															fn_submit: function(){
																...
																$.ajax({
																	...
																	data: {
																		...
																		sqlid: "dashboard.corona.scriptset_script_map.update"
																	}, 
																	async: false,			                    		
									...
									// options for the Script Master Del Dialog 
									{
										...
										{ 
											...
											$.ajax({
												...
												data: {
													searchJson: JSON.stringify(paramObj),
													sqlid: "dashboard.corona.scriptset_script_map.delete"
												}  , 
												async: false,
												success:  function(data){
													response1 = data;
		...
		function fn_search_firmware(){
			...
			setTimeout( function(){
				...
				var paramObj = {
					...
					sqlid: "dashboard.corona.manage.script.scriptset.mapping"
				};
				$.ajax({
					type: "POST",
					url: "/dashboard/genericlListJson.html",
					//data: {searchJson: JSON.stringify(paramObj), sqlid: "dashboard.corona.manage.script.scriptset.mapping"}, 
					//data: $("#form").serialize(), 
					data: paramObj,
					async: false,
					success:  function(response){
