					...
					type:'chart',
   	            	...
   	            	// searchGrid에서 선택된 folder
	            		...
	            		var series = getDrillDownDataSeries2(
	            				...
	            				['SLOTNAME'] , //groupby
	            				[], //filter
	            				[{col: 'VALUE' , convert:'z',isnull:0}], //convert
	            				'TESTNAME' ,  //category
	            				'CNT',
...
//            			        }
	            		...
	            		var xCategories = alasql('select distinct mysplit(TESTNAME,"_") as testname , TESTNAME as testnamefull from ?  order by 1' , [dataSmart.dataList]);	  
	            		...
	            		var yCategories = alasql('select distinct ID id , NAME name from ?  order by 1' , [dataSmart.dataList]);	  
	            		yCategories = _.map(yCategories,function(m,i){
	            			return {idx:i , attribute_id: m.id, attribute_name: m.name};
	            		});
	            		
	            		var yCategories1 =  _.pluck(yCategories,'attribute_id');
	            		...
	            		dataSmart.yAxis = yAxis;
	            			...
	            			$.each(series.series, function(i,s){
	            				$.each(s.data,function(j,d){
	            					var  targetCategory = alasql('select idx from ? where attribute_id = ' + d.ID  + ' ', [yCategories]);
	            					if(targetCategory.length > 0)
	            						d.y = targetCategory[0].idx;
	            				});
	            			});
						...
						{	
	    	            	...
	    	            	data: function(){
    		            		...
    		            		var series = getDrillDownDataSeries2(
    		            				'',
    		            				dataSmart.dataList ,
    		            				['SLOTNAME','ID','TESTNAME'] , //groupby
    		            				[], //filter
    		            				[{col: 'VALUE' , convert:'y',isnull:0}], //convert
    		            				'ID' ,  //category
    		            				'CNT',
    		            				{cd:'SLOTNAME', name:'SLOTNAME'},
    		            				{isGroupby: false}
    		            		...
    		            		var xCategories = alasql('select distinct ID id , NAME name, TESTNAME testname from ?  order by 1 , 3' , [dataSmart.dataList]);
    		            		xCategories = _.map(xCategories,function(m,i){
    		            			return {
    		            				idx:i , 
    		            				attribute_id: m.id, 
    		            		...
    		            		rtn.xAxis = xAxis;
    		            			...
    		            			$.each(series.series, function(i,s){
    		            				$.each(s.data,function(j,d){
    		            					var  targetCategory = alasql('select idx from ? where attribute_id = ' + d.ID  + ' and testname="'+ d.TESTNAME+'"	', [xCategories]);
    		            					if(targetCategory.length > 0)
    		            						d.x = targetCategory[0].idx;
    		            				});
    		            			});
					...
					type:'chart',
   	            	...
   	            	// searchGrid에서 선택된 folder
	            		...
	            		var chart_param = {
	            				...
	            				seriesIndex:{sql:'create index idx_SLOTNAME on smart(SLOTNAME)', index : 'idx_SLOTNAME'},
	            				//filters: [] ,
	            				convertDefiines: [{col: 'VAL' , convert:'z',isnull:0}] ,
	            				xCategoryCol : 'TESTNAME',
	            				xCategoryAddIfEmpty: false ,
	            				xCategoryIndex :'idx_TESTNAME_SLOTNAME', // xCategoryAddIfEmpty == true 인경우 유효. 속도에 절대적인 요소.  
	            				xCategoryIndicate: true,
				...
				,{
                  ...
                  return dataList;
			    	...
			    	items:[
						...
						{label:'No',name:'ROW_NO', id:'ROW_NO',sorttype:'number',align:'center', search: false,width: 60},
                  ...
                  {label:'Test Name',name:'TESTNAME_FULL', id:'TESTNAME_FULL',width: 270 
			    	...
			    	gridOpt:{
			    		...
			    		sortable: true,
			    		multiSort:true,
		    		   sortname: 'FIRMWARE, PJT_CODE, FOLDER_NAME, ROW_NO,TESTNAME_FULL',
			    		rowNum: 20, 
						rowList:[10,20,30,50,100],
			    		//forceFit : false ,
			    		gridComplete: function () {
