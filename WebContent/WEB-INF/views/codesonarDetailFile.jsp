...
<head>
	...
	function drawChart(priority){				
		...
		$('#container').highcharts({
	        ...
	        plotOptions: {
	            series: {
	                ...
	                point: {
	                    events: {
	                        click: function () {
	                            if(parent.drawChartCodesonarFunction)
	                            	parent.drawChartCodesonarFunction($("#sProject").val(),this.category);
	    	...
	    	if(parent.drawChartCodesonarFunction && dataH.length >0 ){
	    		parent.drawChartCodesonarFunction($("#sProject").val(),dataH[0].optionsdata[0]);
	    	}
