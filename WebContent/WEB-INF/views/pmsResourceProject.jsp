...
<head>
	...
	function drawchartByProjectSiteFuncSubfunc(pjtId,site,func){
		currentFunc = drawchartByProjectSiteFuncSubfunc;
		currentArg = arguments;
		
		var groupKeys = ['PJT_ID','PJT_NAME','NATL_CD','NATL_NAME','UP_PJT_FUNC_NAME','PJT_FUNC_ID','FUNC_NAME','YYYYMM'];
		
		var series = getDrillDownDataSeries2(
				'',
				dataList,
				groupKeys,
				[{col:'PJT_ID',val:pjtId},{col:'NATL_CD',val:site},{col:'UP_PJT_FUNC_NAME',val: func}],
				[{col:'YYYYMM',convert:'x',datatype:'date'},{col:'MM_RESULT',convert:'y',isnull:0}], //convert
				'YYYYMM',
				'MM_RESULT',
				{cd: 'PJT_FUNC_ID', name:'FUNC_NAME'}
		);
		...
		$('#container').highcharts({
	        ...
	        title: {
	        	text:  series.series[0].data[0].NATL_NAME + ' >' + func ,
            	useHTML: true
	        },
	        subtitle: {
	            text: ''
	        ...
	        exporting:{
	        	buttons: [
					...
					}, */
					{
					    ...
					    symbol: 'square',
					    text:'Up to ' + series.series[0].data[0].NATL_NAME + '  >  ' + func
					}
				]
	        },
	        xAxis: {
	            ...
	            area: {
	                ...
	                events:{
	                	click: function(e){
	                		...
	                		drawchartByProjectFuncSubfunc(pjtId,this.name);
                		}  
	                }
	        ...
	        exporting:{
	        	buttons: [
					...
					},
					{
					    ...
					    symbol: 'square',
					    text:'Convert Site > Sub function'
					}
				]
	        },
	        xAxis: {
...
function drawchartByProjectFuncSubfunc(pjtId,func){
	...
	var groupKeys = ['PJT_ID','PJT_NAME','UP_PJT_FUNC_NAME','PJT_FUNC_ID','FUNC_NAME','YYYYMM'];
	/* var series = getDrillDownDataSeries(
			func,
			dataList,
			groupKeys,
        ...
        exporting:{
        	buttons: [
				...
				},
				{
				    ...
				    symbol: 'square',
				    text:'Convert Sub function > Site'
				}
			]
        },
        xAxis: {
