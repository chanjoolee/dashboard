						...
						elements: [
							{
								...
								items:[
									// Project
									{
										label:'Project', name:'PROJECT', id:'PROJECT', width:150, align:'left', sortable:false 
										,editable: true
										,edittype: 'select'
										// ,formatter: 'select'
										,cellattr: function(){
										...
										,editoptions: {
											...
											dataInit: function (element) {
												$(element).change(function(){
													// alert("alkdfjdf");
													var v_project = $(this).val();
													var d_scriptset = $("#search_project").find("[value="+ v_project + "]").attr("scriptset");
													$(this.form).find("#SCRIPTSET").val(d_scriptset);
												});
									...
									// FW Version
									{
										label:'FW Version', name:'FIRMWARE', id:'FIRMWARE', width:150, align:'left', sortable:false , editable: true
										,cellattr: function(){
											// var result = " style=\"background:white;vertical-align: middle;";
											// result += "color: rgba(6, 89, 203, 0.93);font-weight: bolder;cursor:pointer;";
											// return result;
									...
									// Nand Type
									,{
										label:'Nand Type', name:'NAND_TYPE', id:'NAND_TYPE', width:150, align:'center', sortable:false , editable: true
									}
									// REMARK
									,{
										label:'Remark', name:'REMARK', id:'REMARK', width:150, align:'center', sortable:false , editable: true
									}
									// Release Date
									,{
										label:'Release Date', name:'RELEASE_DATE', id:'RELEASE_DATE', width:150, align:'center', sortable:false , editable: true
										,editoptions:{
									...
									// SCRIPTSET
									,{
										label:'TestScript Set', name:'SCRIPTSET', id:'SCRIPTSET', width:150, align:'left', sortable:false
										,editable: true	
										,edittype: 'select'
										//,formatter: 'select'
										, editoptions: {
										...
										formatoptions: {
											...
											,delOptions: {
												onclickSubmit : function(options, rowid) {
													...
													row.sqlid = "dashboard.ssd_sm.firmware.delete";					                        	;
											...
											,afterSave : function(rowid,res) {
												var grid = $(this).jqGrid();
												var row = grid.jqGrid('getRowData',rowid);
												row.project = $("#search_project").val();
												row.sqlid = "dashboard.ssd_sm.firmware.update";
											...
											,onEdit :function(rowid,actop){
												var grid = $(this).jqGrid();
												grid.find("[name=PROJECT][rowid="+rowid+"]").prop('disabled', 'disabled');
												grid.find("[name=FIRMWARE][rowid="+rowid+"]").prop('disabled', 'disabled');
								...
								gridOpt:{
									...
									gridComplete: function () {
										...
										var default_scriptset = $("#search_project").find("option:selected").attr("scriptset");
