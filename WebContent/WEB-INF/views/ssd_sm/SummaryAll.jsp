			...
			elements:[ 
				{
					...
					items: [
						...
						{label:'Project', name:'PROJECT', id:'PROJECT',width: 100, hidden: false, sortable: false
							, align:'center'
							, editable: false
						...
						{label:'Firmware', name:'FIRMWARE', id:'FIRMWARE',width: 100, hidden: false, sortable: false
							, align:'center'
							, editable: false
							, editrules:{edithidden:true}
							,cellattr: function(){
							...
							,formatter: function (cellvalue,col,row) {
								return row.FIRMWARE + ' (' + row.NAND_TYPE + ')'
									+ '<br/>' + row.REMARK
									+ '<br/>' + row.RELEASE_DATE
							}
							, editrules:{edithidden:true}
						},
						{label:'Script Set',name:'SCRIPTSET', id:'SCRIPTSET', align:'center', width: 100, sortable: false
							,cellattr: function(){
								var result = " style=\"vertical-align: middle;";
								result += "color: rgba(6, 89, 203, 0.93);font-weight: bolder;cursor:pointer;";
								return result;
						...
						{label:'Blank',name:'BLANK', id:'BLANK', align:'center', width: 100, sortable: false
							...
							,formatter: function (cellvalue,col,row) {
								...
								'<span style="font-weight: normal">(' + ( row.BLANK_RATIO * 100 ).toFixed(1) + '%' + ')</span>';
							}
							, editrules:{edithidden:true}
						},
						...
						, onCellSelect: function (rowId, iCol, content, event) {
							...
							switch(cm.name){
								...
								case 'SCRIPTSET':
									...
									var linkUrl = "";
									// 1
									linkUrl +="<span style=\"cursor: pointer;\" onclick=\"fn_pop_mgmts_scriptset('"+ row.SCRIPTSET +"',this);\">";
									linkUrl +="Edit/Remove Current TestScript Set.";
									linkUrl +="</span>";
									linkUrl +="<br/><br/>";
									// 2
									linkUrl +="<span style=\"cursor: pointer;\" onclick=\"fn_pop_copy_scriptset('"+ row.SCRIPTSET +"',this);\">";
