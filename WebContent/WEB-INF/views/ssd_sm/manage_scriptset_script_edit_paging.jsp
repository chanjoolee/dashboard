...
<head>
    ...
    <title>SSD TestScriptSet Script Manage</title>
		<%-- 1. jquery --%>
		...
		var schemaContent = {
				...
				elements:[ 
					...
					// target grid
					{
						...
						label:' ',
						items:[	
							{label:'ScriptSet', name:'SCRIPTSET', id:'SCRIPTSET', width:100, align:'left'
								, sortable:false,hidden: true,editable: false, editrules: {edithidden:false }
								, editoptions:{readonly: "readonly"} 
								, search: false
							}
							,{label:'Stage', name:'STAGE', id:'STAGE', width:70, align:'center', sortable:false,editable: false
							...
							,{label:'Category', name:'CATEGORY', id:'CATEGORY', width:120, align:'left', sortable:false
								,editable: false, editrules:{edithidden:false} 
								, search: false
							}
							,{label:'Sub Category', name:'SUB_CATEGORY', id:'SUB_CATEGORY', width:120, align:'left'
								, sortable:false,editable: false, editrules:{edithidden:false} 
								, search: false
							}
							,{label:'Item', name:'ITEM', id:'ITEM', width:120, align:'left', sortable:false , editable: false }
							,{label:'Sub Item', name:'SUB_ITEM', id:'SUB_ITEM', width:120, align:'left', sortable:false , editable: false }
									...
									// options for the Script Master Del Dialog 
									{
										...
										{ 
											...
											$.ajax({
												...
												data: {
													searchJson: JSON.stringify(paramObj),
													sqlid: "dashboard.ssd_sm.scriptset_script_map.delete"
												}  , 
												async: false,
												success:  function(data){
													response1 = data;
