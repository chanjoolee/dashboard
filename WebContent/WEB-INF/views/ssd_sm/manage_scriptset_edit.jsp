										...
										formatoptions: {
											...
											,delOptions: {
												onclickSubmit : function(options, rowid) {
													...
													row.sqlid = "dashboard.ssd_sm.scriptset.delete";					                        	;
											...
											,afterSave : function(rowid,res) {
												var grid = $(this).jqGrid();
												var row = grid.jqGrid('getRowData',rowid);
												row.sqlid = "dashboard.ssd_sm.scriptset.update";
										...
										v_grid.navGrid('#grid_scriptPager' ,
											...
											// options for the Script Master Add Dialog
											{
												...
												{ 
													...
													var response1 = {};
													$.ajax({
														url: "/dashboard/genericSaveJson.html?sqlid=dashboard.ssd_sm.scriptset.insert",
														type: "POST",
														data: fd, 
														async: false,
														cache: false,
