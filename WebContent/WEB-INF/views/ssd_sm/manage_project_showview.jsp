						...
						elements: [
							{
								...
								label:' ',
								items:[
									{label:'Project', name:'PROJECT', id:'PROJECT', width:200, align:'left', sortable:false
										, editable: true 
									...
									// TestScript Set
									,{
										label:'TestScript Set', name:'SCRIPTSET', id:'SCRIPTSET', width:200, align:'left'
										, sortable:false
										,editable: true	
										,edittype: 'select'
										//,formatter: 'select'
										...
										formatoptions: {
											...
											,delOptions: {
												onclickSubmit : function(options, rowid) {
													...
													row.sqlid = "dashboard.ssd_sm.project.delete";					                        	;
											...
											,afterSave : function(rowid,res) {
												var grid = $(this).jqGrid();
												var row = grid.jqGrid('getRowData',rowid);
												row.sqlid = "dashbaord.ssd_sm.project.edit";
