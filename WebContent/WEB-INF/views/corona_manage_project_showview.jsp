...
<head>
   ...
   <!--  <link rel="stylesheet" href="js/jqGrid_JS_5.1.0/css/ui.jqgrid.css" type="text/css" /> --> 
	...
	<%-- 4. local common --%>
	<script src="js/dashboard.js?version=2017.11.17"></script>
					...
					elements: [
						{
					    	...
					    	label:' ',
					    	items:[
								{label:'Project', name:'PROJECT', id:'PROJECT', width:200, align:'left', sortable:false, editable: false }
								,{label:'Use Y/N', name:'USE_YN', id:'USE_YN', width:150, align:'center', sortable:false 
									, editable: true
									, edittype: "select"
									, formatter:"select"
									, editoptions: {
								...
								,{
									...
									, editoptions: {
										...
										value: function(){
											...
											$.ajax({
								    			type: "POST",
								    			url: "/dashboard/genericlListJson.do?sqlid=dashboard.corona.manage.scriptsets.search",
								...
								,{
									...
									formatoptions: {
				                        ...
				                        ,afterSave : function(rowid,res) {
				                        	...
				                        	row.sqlid = "dashbaord.corona.project.useYn.edit";
...
//					    	},		
					    	...
					    	gridOpt:{
					    		...
					    		url:function(){ 
					    			return	"/dashboard/genericlListPageJson.do?" + $("#form").serialize() + "&sqlid=dashboard.corona.project.useYn&paging_sqlid=dashboard.corona.project.useYn.page";
					    		},
// 					    		 jsonReader: {
// 								      root: function(data){
...
//			});
	...
	function fn_pop_copy(v_scriptset){
		...
		oFrm.action =  '/dashboard/generic.do?viewName=corona_manage_copy_template_scriptset';
		oFrm.method = "post";
	...
	function fn_pop_mgmt(v_scriptset){
		...
		//oFrm.menuAuthId.value = "MNU20150422131320740";
		//oFrm.action =  '/dashboard/generic.do?viewName=corona_manage_script';
		oFrm.action =  '/dashboard/generic.do?viewName=corona_manage_scriptset_script_edit_paging';
		oFrm.method = "post";
