        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-300 pd-0-force">
              ...
              <div class="media-list">
                ...
                <a href="" class="media-list-link read">
                  <div class="media pd-x-20 pd-y-15">
                    <img src="templates/bracket/img/img9.jpg" class="wd-40 rounded-circle" alt="">
                    <div class="media-body">
                ...
                <a href="" class="media-list-link read">
                  <div class="media pd-x-20 pd-y-15">
                    <img src="templates/bracket/img/img10.jpg" class="wd-40 rounded-circle" alt="">
                    <div class="media-body">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="templates/bracket/img/img1.jpg" class="wd-32 rounded-circle" alt="">
