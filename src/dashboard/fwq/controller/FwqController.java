...
public class FwqController {
    ...
    @RequestMapping(value = "/fwqCodingRulePop",method = { RequestMethod.GET, RequestMethod.POST })
    public ModelAndView fwqCodingRulePop(@SuppressWarnings("rawtypes") @RequestParam Map<Object,Object> parameter,Locale locale, Model model, HttpServletRequest req,ModelAndView mav) {
    	//parameter.put("pjtCodeList",req.getParameterValues("pjtCodeList"));
    	mav.addObject("searchVO",parameter);
    	mav.setViewName("fwqCodingRulePop");
        return mav;
    }
