 ...
 */
@Controller
public class CodeComplexHistoryJsonController {

    private static final Logger logger = LoggerFactory.getLogger(CodeComplexHistoryJsonController.class);
    ...
    @RequestMapping(value = "/codeComplexHistoryJson")
    public ModelAndView codeComplexHistoryJson(HttpServletRequest request,@RequestParam Map<String,String> parameter,Locale locale, Model model) throws IOException {
