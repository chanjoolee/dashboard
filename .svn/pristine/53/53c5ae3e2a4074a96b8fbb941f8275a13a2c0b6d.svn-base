...
<script type="text/javascript">
	...
	function drawchart(responseData) {
		...
		var useMonth = '${searchVO.useMonth}';
		useMonth = useMonth.substr(0, 4) + "-" + useMonth.substr(4);
		...
		$('#container').highcharts({
	        ...
	        title: {
	        	text:'${searchVO.systemId}' + "<br>(" + useMonth + ")"
	        },
	        subtitle: {
	            text: ''
	        },	    
...
<form name="form" id="form">
	...
	<div class="box_gray" id="container" style="height:${chartHeight};padding-top:15px;background:white;"></div>
</form>
</body>
