 ...
 */
@Controller
public class CodeComplexStatusJsonController {

    private static final Logger logger = LoggerFactory.getLogger(CodeComplexStatusJsonController.class);
    ...
    @RequestMapping(value = "/codeComplexStatusJson")
    public ModelAndView codeComplexStatusJson(HttpServletRequest request,@RequestParam Map<String,String> parameter,Locale locale, Model model) throws IOException {
...
//    		imagePath =  "http://"+request.getServerName()+":"+ request.getServerPort()+ "/codeComplexity/1.RiskyGroup.png";
    		/*imagePath =  "http://"+request.getServerName()+":"+ request.getServerPort()+ 
    				"/codeComplexity/"+lastDir.getName()+
    				"/"+parameter.get("pjt_name").toString()+
    				"/"+"full_files_status.png";*/
